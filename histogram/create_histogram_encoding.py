...
raw_data = pd.read_csv('/Users/dogerdespeville/Documents/these/Article/raw_data_2.csv')
...
for i, row in raw_data.iterrows():
    new_rows_r = []
    new_rows_r.append([row['encobanane'],row['M/C'],'Banana'])
    new_rows_r.append([row['encocitron'],row['M/C'],'Lemon'])
    new_rows_r.append([row['encolavande'],row['M/C'],'Lavender'])
    new_rows_r.append([row['encotruffe'],row['M/C'],'Truffle'])
